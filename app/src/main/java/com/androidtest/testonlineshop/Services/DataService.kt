package com.androidtest.testonlineshop.Services

import com.androidtest.testonlineshop.Category
import com.androidtest.testonlineshop.Product
...
object DataService {
    ...
    var hoodies = listOf(
        Product("gray hoodie","$20","hoodie1"),
    ...
    var digitals = listOf(
        Product("gray digital","$20","digital1"),
